              ...
              <Tabs className="tab-content nav-material">
                <TabList className="nav nav-tabs nav-material">
                  <Tab className="nav-item">
                    ...
                    >
                      <i className="icofont icofont-ui-home" />Specifications
                    </span>
                  ...
                  <Tab className="nav-item">
                    <span
                      ...
                      style={{ fontSize: "80%", margin: "auto" }}
                    >
                      <i className="icofont icofont-man-in-glasses" />Overview
                    </span>
                    <div className="material-border" />
                  </Tab>
                  <Tab className="nav-item">
                    <span
                      ...
                      style={{ fontSize: "80%", margin: "auto" }}
                    >
                      <i className="icofont icofont-contacts" />Reviews(
                  ...
                  <Tab className="nav-item">
                    <span
                      ...
                      style={{ fontSize: "80%", margin: "auto" }}
                    >
                      <i className="icofont icofont-contacts" />Write Review
                    </span>
                    <div className="material-border" />
                  </Tab>
                </TabList>
