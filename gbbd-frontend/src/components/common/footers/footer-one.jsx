                ...
                <div className="col-lg-6">
                  <div className="subscribe">
                    <div>
                      ...
                      <p>
                        Never Miss Anything From GlobalbuyBD By Signing Up To
                        Our Newsletter.{" "}
                      </p>
                    </div>
                  </div>
              ...
              <div className="col-lg-4 col-md-6">
                ...
                <div className="footer-contant">
                  ...
                  <p>
                    ...
                    GlobalbuyBD এর সাথে। আমরাই দিচ্ছি সবচেয়ে দ্রুত গতিতে পন্য
                  ...
                  <div className="footer-social">
                    <ul>
                      <li>
                        {" "}
                        <a
                          href="https://www.facebook.com/globalbuybdB2B/"
                          target="_blank"
                        >
                  ...
                  <div className="footer-contant">
                    <ul className="contact-list">
                      <li>
                        ...
                        GlobalbuyBD,pritom zaman tower,level-10
                      </li>
                      <li>
                        <i className="fa fa-phone" />
                        Call Us: +88-01608-064952
                      </li>
                      <li>
                        <i className="fa fa-envelope-o " />
                        Email Us:{" "}
                        <a href="#" className="style-email">
                          globalbuybd@gmail.com
                        </a>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="col-xl-6 col-md-6 col-sm-12">
                <div className="footer-end">
                  <p>
                    ...
                    2020-2022 Globalbuybd.com. All rights reserved.
                  </p>
                </div>
              </div>
              <div className="col-xl-6 col-md-6 col-sm-12">
